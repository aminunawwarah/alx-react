...
Add two buttons under the text Here is the list of notifications. The first one contains ??. On click, it set the filters of notifications to URGENT. The second one contains ??. On click, it sets the filter of notifications to DEFAULT
Repo:
